...
const Product = () => {
  ...
  return <div className="min-h-screen">
      ...
      x: 0
        ...
        <Button onClick={() => navigate(-1)} size="lg" className="rounded-full shadow-elegant glass-effect hover:scale-105 transition-all duration-300 group bg-zinc-950 hover:bg-zinc-800">
